...
function carousel(sprites) {
    return `<div id="carouselExempleAutoplaying" class="carousel slide" data-bs-ride="carousel">
                    <div calss="carousel-inner">
                        <div class="carousel-item active">
                        <img scr= "${sprites.other["official-artwork"].front_default}" class="d-block w-100" alt="Padrão">
                        </div>
